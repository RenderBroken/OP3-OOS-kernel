...
ZIMAGE_DIR="${HOME}/android/source/kernel/OP3-OOS-kernel/arch/arm64/boot"

# Functions
function checkout_ak_branches {
		cd $REPACK_DIR
		git checkout rk-op3-oos-n
		cd $KERNEL_DIR
}
...
echo "Pick Toolchain..."
select choice in LINARO-aarch64-linux-gnu-4.9.3-05012016 LINARO-aarch64-linux-gnu-5.3.1-05012016 LINARO-aarch64-linux-gnu-6.3.1-052017 LINARO-aarch64-linux-gnu-7.1.1-062017
do
case "$choice" in
